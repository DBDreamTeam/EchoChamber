...
<h3>This is the <?php echo getChatNameFromID($chatID, $link); ?> chat! </h3>

<p> You are chatting to: <?php displayChatMembers($chatID, $userID, $link); ?> </p>

<p> Write a message to your friends! </p>

<form action = "../process/processChatMessage.php" method = "post" id="msgForm" enctype="multipart/form-data">
    <textarea name="message" form="msgForm" placeholder = "Craft your words here!"></textarea>
    <p>Include a photo:</p><input type="file" name = "uploadedimage" id="fileToUpload"><br>
    <input type = "submit" class="btn btn-default" value = "Send Message" name="submit">
</form>
