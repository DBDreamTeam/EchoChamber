...
if (!empty($_POST["friendUsername"])) {
  $_SESSION["friend2"] = $_POST["friendUsername"];
}
...
?>
	...
	<form method="POST">
		...
		if(isset($_POST['addFriend'])) {
			$addFriendQuery = "INSERT INTO friend_requests (id,user_from, user_to) VALUES (NULL,'$LoggedUserID', '$FriendUserID')";
